...
Compiled Compact contract bindings for [silentpass](https://www.npmjs.com/package/silentpass), the
reusable zero-knowledge identity credential on Midnight.

This package is a dependency of `silentpass` and `silentpass-react`. Most users do not install it
...
[repository](https://github.com/ogsamrat/silentpass) under `contract/src/managed`.
