      ...
      <div className="wrap">
        ...
        {!ctl.connected ? (
          <div className="connect-card" data-reveal>
            ...
            <p>Use Lace or 1AM with the DApp Connector, set to preprod. Proofs are generated by your wallet's proof server (Lace runs one locally; 1AM uses a hosted one), never by this site. You will need a small DUST balance for fees.</p>
