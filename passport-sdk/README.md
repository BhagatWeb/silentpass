...
[![npm](https://img.shields.io/npm/v/silentpass.svg)](https://www.npmjs.com/package/silentpass)
[![license](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](https://github.com/ogsamrat/silentpass/blob/main/LICENSE)

```bash
npm install silentpass
```
...
```ts
import { PassportAPI, Issuer, Holder } from 'silentpass';
...
[repository](https://github.com/ogsamrat/silentpass) (`verifier-ui/src/midnight`).

## React

For a React app, [`silentpass-react`](https://www.npmjs.com/package/silentpass-react) gives you a
drop-in gate:
